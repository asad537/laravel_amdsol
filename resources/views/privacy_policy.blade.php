...
<head>
    ...
    <title>Privacy Policy - AmdSol</title>
...
<body>
    ...
    <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to AmdSol, 9933 Franklin Ave Franklin Park IL 60131.</li>
        ...
        <li><strong>Service</strong> refers to the Website and any related services offered.</li>
        ...
        <li><strong>Website</strong> refers to AmdSol, accessible from <a href="https://www.amdsol.com/" rel="external nofollow noopener" target="_blank">https://www.amdsol.com/</a>.</li>
        <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
    </ul>

    <h2>Governing Law and Regulatory Compliance</h2>
    <p>Our collection, use, and disclosure of Your Personal Data is governed by and complies with applicable data protection and privacy laws, including but not limited to:</p>
    <ul>
        <li><strong>United States:</strong> The Company adheres to relevant federal and state laws, including regulations enforced by the <strong>Federal Trade Commission (FTC)</strong>. We comply with state-specific privacy laws, such as the <strong>California Consumer Privacy Act (CCPA)</strong> as amended by the California Privacy Rights Act (CPRA), the <strong>Virginia Consumer Data Protection Act (VCDPA)</strong>, and other applicable state statutes. Where our services involve financial data or specific sectors, we also comply with regulations from bodies such as the <strong>Consumer Financial Protection Bureau (CFPB)</strong> and other relevant federal and state regulators.</li>
        <li><strong>International:</strong> For users located outside the United States, we respect the privacy laws of their jurisdictions. Where applicable, and particularly for users in the European Economic Area (EEA) and United Kingdom, we recognize the principles of the <strong>General Data Protection Regulation (GDPR)</strong> and the <strong>UK GDPR</strong>. We also observe cross-border data transfer mechanisms as required by law.</li>
    </ul>
    <p>This Privacy Policy is designed to meet our obligations under these regulations. For more information on your specific rights under these laws, please see the "<strong>Your Privacy Rights</strong>" section below.</p>
    ...
    <ul>
        <li><strong>Necessary / Essential Cookies:</strong> (Session Cookies) Essential to provide You with services available through the Website and to enable You to use some of its features.</li>
        <li><strong>Cookies Policy / Notice Acceptance Cookies:</strong> (Persistent Cookies) Identify if users have accepted the use of cookies on the Website.</li>
        <li><strong>Functionality Cookies:</strong> (Persistent Cookies) Allow Us to remember choices You make when You use the Website, such as remembering your login details or language preference.</li>
    </ul>
    ...
    <ul>
        <li><strong>With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, to contact You, and for payment processing.</li>
        <li><strong>For business transfers:</strong> We may share or transfer Your Personal Data in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition.</li>
        ...
        <li><strong>With other users:</strong> If You share Personal Data or otherwise interact in public areas with other users, such information may be viewed by all users.</li>
    ...
    <p>We apply different retention periods:</p>
    <ul>
        ...
        <li><strong>Usage Data (analytics, logs):</strong> Up to 24 months from the date of collection.</li>
    </ul>
    <p>We may retain Personal Data longer where required by legal obligation, to establish, exercise, or defend legal claims, upon Your request, or due to technical limitations in backup systems.</p>

    <h3>Transfer of Your Personal Data</h3>
    <p>Your information, including Personal Data, is processed at the Company's operating offices and in any other places where the parties involved in the processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ.</p>
    <p>Where required by applicable law, We will ensure that international transfers of Your Personal Data are subject to appropriate safeguards (such as standard contractual clauses approved by relevant authorities). The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy.</p>

    <h2>Your Privacy Rights</h2>
    <p>Depending on Your location and applicable law, You may have the following rights regarding Your Personal Data:</p>
    <ul>
        <li><strong>Right to Know/Access:</strong> Request to know what Personal Data we have collected, used, disclosed, or sold.</li>
        ...
        <li><strong>Right to Opt-Out of Sale/Sharing:</strong> Opt-out of the "sale" of Your Personal Data or its sharing for cross-context behavioral advertising, as defined under laws like the CCPA.</li>
        <li><strong>Right to Limit Use and Disclosure of Sensitive Personal Information:</strong> Request limits on the use of sensitive personal information.</li>
        <li><strong>Right to Data Portability:</strong> Request a copy of Your Personal Data in a structured, commonly used, and machine-readable format.</li>
    ...
    <p>To exercise any of these rights, please contact Us using the details in the "<strong>Contact Us</strong>" section. We may need to verify Your identity before processing Your request, which may require You to provide specific information. We will respond to Your request within the timeframes required by applicable law.</p>
    ...
    <h4>Law Enforcement and Regulatory Bodies</h4>
    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law, regulation, or in response to valid requests by public authorities, including but not limited to courts, government agencies, and regulatory bodies such as the <strong>Federal Trade Commission (FTC)</strong>, <strong>Consumer Financial Protection Bureau (CFPB)</strong>, state Attorneys General, or other authorized entities as permitted or required by applicable law.</p>
    ...
    <p>The security of Your Personal Data is important to Us. We implement appropriate technical and organizational measures designed to protect the security of Your Personal Data, including encryption, access controls, and secure network architectures. However, no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
    ...
    <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page, updating the "Last updated" date, and, where required by law, providing more prominent notice (e.g., via email or a notice on Our Service). You are advised to review this Privacy Policy periodically for any changes.</p>
    ...
    <p><strong>For California Residents:</strong> Please see our separate <strong>California Privacy Notice</strong> for additional disclosures required under California law.</p>
</body>
</html>
